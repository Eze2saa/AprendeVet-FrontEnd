...
@Component({
  selector: 'ejercicio-inicial',
  templateUrl: './ejercicio-inicial.component.html',
  styleUrl: './ejercicio-inicial.component.scss',
  animations: [
    trigger('fadeIn', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class EjercicioInicialComponent implements OnInit, AfterViewInit {
