...
@Component({
  selector: 'regulacion-glucosa-inicial',
  templateUrl: './regulacion-glucosa-inicial.component.html',
  styleUrl: './regulacion-glucosa-inicial.component.scss',
})
export class RegulacionGlucosaInicialComponent implements OnInit {
